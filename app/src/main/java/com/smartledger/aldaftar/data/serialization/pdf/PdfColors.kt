/**
 * =====================================================================
 * ملف: ثوابت ألوان وسمات تقارير  (.)
 * =====================================================================
 * 
 * [الغرض العام والتعليمي من الملف]:
 * يحتوي هذا الكائن على لوحة الألوان المعيارية والاحترافية ( ) المستخدمة
 * في رسم مستندات  وكشوفات الحسابات وجداول الأستاذ العام بواسطة  ،
...
/**
 * [الكائن الأحادي لألوان تقارير  - ]:
 * يجمع رموز الألوان الست عشرية () المخصصة لمحركات رسم التقارير المطبوعة.
 * تم تحويله بالكامل ليعمل كـ /  يعتمد على  كمصدر للحقيقة.
 */
object PdfColors {
