/**
 * =====================================================================
 * ملف: أدوات التلوين وأنماط الخطوط في  (.)
 * =====================================================================
 * 
 * [الغرض العام والتعليمي من الملف]:
 * يمثل هذا الكائن مستودعاً مركزياً لكائنات التلوين والفرش [] ومحركات
 * خطوط النصوص [] المستخدمة في رسم مستندات .
 * من خلال تجميع كائنات [] وإعادة استخدامها، نتفادى إنشاء كائنات جديدة
 * أثناء تكرار رسم الصفوف، مما يحسن الأداء ويمنع استنزاف الذاكرة أثناء توليد الدفاتر الكبيرة.
 * 
 * [المسؤوليات المعمارية والتقنية]:
 * 1. إعادة استخدام الكائنات وتخفيف العبء على جامع القمامة (تقليل إنشاء الكائنات المتكرر):
 *    - تهيئة وتثبيت كائنات [] مسبقاً لاستخدامها في كل خلايا الجداول.
 * 2. التوحيد البصري للألوان والخطوط (الاتساق البصري):
 *    - تطبيق ثوابت [] على أنماط الخطوط العادية والعريضة بدقة نقطية ( ).
 * 3. دعم تلوين المعاملات المالية (التنسيق المالي الدلالي):
 *    - خلفيات ونصوص المديونيات [, ].
 *    - خلفيات ونصوص المقبوضات والمدفوعات [, ].
 */
...
/**
 * [الكائن الأحادي لأدوات التلوين والخطوط - ]:
 * يحتوي على كافة كائنات الرسم والتنسيق الجاهزة لمحرك .
 */
object PdfPaints {
    ...
    /**
     * [إنشاء وتجهيز أداة تلوين نصية - ]:
     * دالة مساعدة داخلية لإنشاء كائن [] مع تفعيل تنعيم الحواف [].
     */
