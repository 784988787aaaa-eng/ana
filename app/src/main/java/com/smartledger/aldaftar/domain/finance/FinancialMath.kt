/**
 * =====================================================================
 * ملف: محرك الحسابات المالية الدقيقة (.)
 * =====================================================================
 * هذا الملف هو البوابة المركزية للعمليات الحسابية المالية داخل التطبيق.
 * يمنع هذا التجميع استعمال / في الحسابات النقدية الحديثة، مع
 * الإبقاء على التحويل إلى  محصوراً في حدود التوافق مع مخطط  القديم.
 */
...
object FinancialMath {
    ...
    /**
     * يحول النص القادم من واجهة الإدخال إلى  دون المرور بـ .
