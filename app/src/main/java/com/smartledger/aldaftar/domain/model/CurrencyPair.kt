/**
 * =====================================================================
 * ملف: كائن زوج العملات وسعر الصرف (.)
 * =====================================================================
 * 
 * [الغرض العام والتعليمي من الملف]:
 * يمثل هذا الملف كائن قيمة آمن النمط (-  ) لتمثيل زوج العملات
 * (مثل: / أو /) وسعر التحويل أو الصرف المالي بينهما في طبقة النطاق.
 * يغلف قيود التحقق من صحة السعر وقواعد التقريب المحاسبي البنكي (' ).
 * 
 * [المسؤوليات المعمارية والتقنية للملف]:
 * 1. نمذجة أسعار الصرف (  ):
 *    - تمثيل العملة الأساسية []، والعملة المستهدفة []، وسعر الصرف كـ [].
 * 2. التحقق من صحة وقوة السعر (  & ):
 *    - فحص كون السعر موجباً وأكبر من الصفر عبر [].
 *    - توفير سعر آمن [] بدقة 4 خانات عشرية باستخدام نمط تقريب الصيرفة [._].
 * 3. تمييز التحويل الذاتي (- ):
 *    - معرفة ما إذا كان التحويل لنفس العملة عبر [] دون الحاجة لإجراء عمليات ضرب معقدة.
 */
...
/**
 * [فئة بيانات زوج العملات - ]:
 * @  رمز العملة الأساسية (مثل: ).
 * @  رمز العملة المستهدفة للتحويل إليها (مثل: ).
 * @  معامل أو سعر الصرف بين العملتين كقيمة [] فائقة الدقة.
 */
