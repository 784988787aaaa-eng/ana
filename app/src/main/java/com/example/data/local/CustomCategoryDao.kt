...
// =====================================================================
// 1) DAO هو حد التخاطب المباشر مع جدول التصنيفات؛ يُستحسن إبقاء قواعد العرض
//    والتسمية خارج هذه الطبقة.
// 2) أي استعلام جديد ينبغي مراجعته من ناحية الفهارس، خصوصاً عند ازدياد عدد
//    التصنيفات أو إدخال بحث نصي متكرر.
// 3) الحفاظ على أنواع الإرجاع الحالية مهم حتى لا تتغير عقود ViewModel المستهلكة.
