...
// =====================================================================
// 1) استخدام BigDecimal مع toPlainString هو الخيار الصحيح للمبالغ المالية،
//    ويجب الحفاظ عليه عند أي توسعة لمخطط البيانات.
// 2) cleanNumberString يحمل سياسة تطهير مهمة؛ أي تعديل عليه يجب أن يسبقه اختبار
//    شامل للأرقام العربية والفارسية والفواصل والإشارات والقيم التالفة.
// 3) التحويل إلى Double مخصص للتوافق؛ لا ينبغي استخدامه كمسار حساب مالي دقيق.
// 4) إعادة null عند فساد القيمة أفضل من تحويلها بصمت إلى صفر، ويجب الحفاظ على
//    هذا السلوك عند إضافة مصادر إدخال جديدة.
