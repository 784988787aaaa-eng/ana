...
// =====================================================================
// 1) هذه الحركة تحمل دلالات مالية وروابط محتملة مع دفتر اليومية؛ لذلك فإن أي
//    تغيير في linkedMainTxId أو نوع المبلغ يجب أن يراجع من ناحية التكامل بين الطبقات.
// 2) الحقول الزمنية والهوية يجب أن تبقى مستقرة لضمان صحة التاريخ والتقارير.
