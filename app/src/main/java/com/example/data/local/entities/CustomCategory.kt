...
// =====================================================================
// 1) الكيان يمثل تعريف التصنيف المخصص المخزن محلياً، ولذلك يجب فصل خصائص العرض
//    المؤقتة عن الحقول التي تشكل هوية السجل.
// 2) أي تغيير في المفتاح الأساسي أو الأعمدة يستلزم Migration واختبار استعادة.
