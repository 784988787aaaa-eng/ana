...
// =====================================================================
// 1) هذا Entity يمثل عقد التخزين للإعدادات؛ أسماء الأعمدة وأنواعها جزء من مخطط
//    Room ولا يجوز تغييرها بلا Migration صريح.
// 2) الحقول الأمنية والإعدادية حساسة من ناحية التوافق؛ يجب اختبار القراءة من
//    قواعد البيانات القديمة بعد كل إصدار.
