...
// =====================================================================
// 1) سلة المهملات تمثل طبقة أمان لاسترجاع العناصر المحذوفة؛ الحذف النهائي يجب
//    أن يبقى منفصلاً بوضوح عن النقل إلى السلة.
// 2) عمليات bulk delete/restore تستحق اختبارات للتأكد من عدم وجود عناصر يتيمة
//    أو ازدواجية بعد الاستعادة.
// 3) أي تغيير في مدة الاحتفاظ يجب أن يُنسق مع TrashCleanupWorker وليس داخل DAO فقط.
