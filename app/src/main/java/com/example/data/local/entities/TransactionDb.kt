...
// =====================================================================
// 1) هذا الكيان هو تمثيل التخزين للحركة الرئيسية؛ ينبغي عدم إدخال منطق حسابي
//    معقد داخله حتى تبقى طبقة البيانات قابلة للاختبار والتغيير.
// 2) أي تغيير في أنواع المبالغ أو العملات يجب أن يتزامن مع BigDecimalConverter
//    والهجرات والاستعلامات والتقارير.
