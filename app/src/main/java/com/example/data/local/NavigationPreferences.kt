...
// =====================================================================
// 1) هذه الطبقة تخص تفضيلات التنقل المحلية؛ ينبغي عدم خلطها مع بيانات الحساب
//    المحاسبية أو مخطط Room ما لم توجد حاجة معمارية واضحة.
// 2) أي مفتاح تفضيل جديد يجب أن يملك قيمة افتراضية مستقرة حتى لا تتأثر الأجهزة
//    القديمة بعد التحديث.
