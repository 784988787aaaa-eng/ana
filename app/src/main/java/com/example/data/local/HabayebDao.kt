...
// =====================================================================
// 1) هذا DAO يجمع عمليات العملاء وحركاتهم؛ يجب الحفاظ على وضوح الفصل بين قراءة
//    الحالة الحالية وقراءة السجل التاريخي عند إضافة استعلامات جديدة.
// 2) الاستعلامات التي تعيد Flow تشكل قناة مباشرة إلى واجهة المستخدم؛ أي تغيير في
//    شروطها قد يغير ما يظهر للمستخدم دون تعديل في Compose.
// 3) عمليات الحذف/الاستعادة والترابط بين الحركات تحتاج اختبارات تكاملية تحمي
//    سلامة العلاقات قبل أي إعادة هيكلة مستقبلية.
