/*
 * توثيق هندسي عربي — SecurityActivePanel.kt
 *
 * المسؤولية المعمارية:
 * مكوّن العرض الذي يظهر عندما يكون الأمان مفعلاً، ويجمع إجراءات إدارة الحماية والتحقق من بيانات الاعتماد الحالية قبل تنفيذ العمليات الحساسة.
 *
 * القراءة التعليمية:
 ...
 *
 * - إبقاء تأكيد الاعتماد الحالي شرطاً قبل أي تغيير أمني، ومراقبة أن جميع المسارات المستقبلية تحافظ على هذا الحاجز.
 * - توحيد رسائل الخطأ الحساسة بحيث لا تميز بين أسباب الفشل الأمنية الدقيقة.
 */
