            ...
            when (val state = googleSyncState) {
                    ...
                    Column(
                        ...
                        Button(
                            ...
                            Row(
                                ...
                                Icon(Icons.Default.Link, contentDescription = null, tint = MaterialTheme.colorScheme.onPrimary, modifier = Modifier.size(16.dp))
                                Text(stringResource(R.string.backup_btn_gdrive_quick), color = MaterialTheme.colorScheme.onPrimary, fontSize = 12.sp, fontWeight = FontWeight.Bold)
                            }
                        }
                            ...
                            Card(
                                ...
                                Column(
                                    ...
                                    Button(
                                        ...
                                        Text(stringResource(R.string.backup_btn_gdrive_open_browser), color = MaterialTheme.colorScheme.onPrimary, fontSize = 10.sp, fontWeight = FontWeight.Bold)
                                    }
                                    ...
                                    Button(
                                        ...
                                        Text(stringResource(R.string.backup_btn_oauth_confirm), fontSize = 11.sp, color = MaterialTheme.colorScheme.onPrimary, fontWeight = FontWeight.Bold)
                                    }

                                    Spacer(modifier = Modifier.height(4.dp))
                                    TextButton(
                                        onClick = { openGoogleDriveApp(context) },
                                        modifier = Modifier.align(Alignment.CenterHorizontally)
                                    ) {
                                        Text(
                ...
                is CloudSyncState.Authenticating -> {
                    Row(
                        ...
                        CircularProgressIndicator(modifier = Modifier.size(16.dp), color = EmeraldPrimary)
                ...
                is CloudSyncState.Success, is CloudSyncState.Skipped, is CloudSyncState.Authenticated -> {
                    ...
                    Column(
                        ...
                        val warningBg = MaterialTheme.colorScheme.errorContainer.copy(alpha = 0.3f)
                        ...
                        Button(
                            ...
                            Row(
                                ...
                                Icon(Icons.Default.BackupTable, contentDescription = null, tint = MaterialTheme.colorScheme.onSecondary, modifier = Modifier.size(16.dp))
                                Text(stringResource(R.string.backup_btn_browse_archives), fontSize = 11.sp, color = MaterialTheme.colorScheme.onSecondary, fontWeight = FontWeight.Bold)
                            }
                        }
