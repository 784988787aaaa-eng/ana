    ...
    val googleSignInLauncher = rememberLauncherForActivityResult(
        ...
        if (result.resultCode == Activity.RESULT_OK && intent != null) {
            ...
            if (isCancelled) {
                ...
                Toast.makeText(context, context.getString(R.string.settings_gdrive_link_failed_api_code_pattern, errorCode), Toast.LENGTH_LONG).show()
            }
        }
    }
    ...
    ElevatedCard(
        ...
        Column(
            ...
            Column(
                ...
                // 1. File Transfer & Discovered Backups Section
                FileTransferManager(
                    backupSyncViewModel = backupSyncViewModel,
                    context = context,
                ...
                // 3 & 4. Cloud Backup Section (Direct Sync & Manual SAF backup)
                CloudBackupSection(
                    backupSyncViewModel = backupSyncViewModel,
                    isDark = isDark,
                    context = context,
