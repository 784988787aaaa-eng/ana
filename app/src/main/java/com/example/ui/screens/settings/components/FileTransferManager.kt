...
fun FileTransferManager(
    ...
    Column(
        ...
        QuadBackupItem(
            ...
            icon = { Icon(Icons.Default.Save, contentDescription = null, tint = MaterialTheme.colorScheme.primary, modifier = Modifier.size(18.dp)) }
        ) {
            Row(
                modifier = Modifier.fillMaxWidth(),
                ...
                Button(
                    ...
                    Text(stringResource(R.string.settings_export_mzd), fontSize = 11.sp, color = MaterialTheme.colorScheme.onPrimary, fontWeight = FontWeight.Bold)
                }
                ...
                Button(
                    ...
                    Text(stringResource(R.string.settings_import_mzd), fontSize = 11.sp, color = MaterialTheme.colorScheme.onPrimaryContainer, fontWeight = FontWeight.Bold)
                }
            }
        }
