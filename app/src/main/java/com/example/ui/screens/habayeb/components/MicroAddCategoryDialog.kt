 ...
 * ╚══════════════════════════════════════════════════════════════════════╝
 *
 * الملف: app/src/main/java/com/example/ui/screens/habayeb/components/MicroAddCategoryDialog.kt
 * القطاع المعماري: Habayeb UI/UX.
 *
 * الوصف المعماري:
 * حوار Compose متخصص (MicroAddCategoryDialog) يعرض قراراً أو إعداداً أو إدخالاً في سياق شاشة الحبايب.
 *
 ...
 * البصمة SHA-256 للنص الأصلي قبل التوثيق: 1d9e6a4a8f0da18cf884d3935d7398d4cec84103817f098675dd1d7bedc5bc69
 *
 ...
 * السطر 65: فرع شرطي يحدد مسار التنفيذ حسب الحالة الحالية.
 ...
 * السطر 73: أثر Compose مرتبط بدورة حياة التركيب أو تغيّر المفاتيح.
 ...
 * السطر 80: معالجة استثناءات للحفاظ على مسار التنفيذ المتفق عليه.
