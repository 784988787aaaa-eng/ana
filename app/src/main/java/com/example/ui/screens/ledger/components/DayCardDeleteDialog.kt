 ...
 * ╚══════════════════════════════════════════════════════════════════════╝
 *
 * الملف: app/src/main/java/com/example/ui/screens/ledger/components/DayCardDeleteDialog.kt
 * القطاع المعماري: Ledger UI/UX.
 *
 * الوصف المعماري:
 * حوار Compose متخصص (DayCardDeleteDialog) يعرض قراراً أو إعداداً أو إدخالاً في سياق شاشة الحبايب.
 *
 ...
 * البصمة SHA-256 للنص الأصلي قبل التوثيق: 26221f01e0157b4ade972bb8532684ae57e5cc2a2d13b29ca31bb34009177ae9
 *
