 ...
 * ╚══════════════════════════════════════════════════════════════════════╝
 *
 * الملف: app/src/main/java/com/example/ui/screens/habayeb/utils/HabayebDateFormatter.kt
 * القطاع المعماري: Habayeb UI/UX.
 *
 * الوصف المعماري:
 * مكوّن اختيار التاريخ/الوقت (HabayebDateFormatter) يحوّل تفاعل المستخدم إلى قيمة زمنية منظمة مع الحفاظ على عقد الاستدعاء الأصلي.
 *
 ...
 * البصمة SHA-256 للنص الأصلي قبل التوثيق: c51ebc9815f66ed85d1f44e949c35fc1005d513ba4eba00c3ae5e51378f4c341
 *
 ...
 * السطر 22: تعريف دالة؛ نقطة تنفيذ أو Composable تستقبل مدخلات وتنتج أثراً أو واجهة.
...
/**
 * Legacy delegate to unified AppDateTimeFormatter.
 */
