/*
 * توثيق هندسي عربي — AppLockScreen.kt
 *
 * المسؤولية المعمارية:
 * واجهة قفل التطبيق التي تنسق مسارات فتح القفل: رمز المرور، البصمة/المصادقة الحيوية، وعبارة الاسترداد. أثناء القراءة يمكن تصور شاشة محمية لا تسمح بالوصول إلى الدفتر إلا بعد نجاح التحقق، مع الحفاظ على دورة حياة الحالة وعدم تسريب المدخلات الحساسة.
 *
 * القراءة التعليمية:
 ...
 *
 * - تقليل نطاق الحالة الحساسة داخل Composable قدر الإمكان، مع إبقاء القرار الأمني النهائي في طبقة المجال/الـViewModel.
 * - التأكد دورياً من أن رسائل Toast والحالات الانتقالية لا تكشف طول أو قيمة بيانات الاعتماد.
 * - اختبار lifecycle عند تدوير الشاشة/إعادة الإنشاء للتأكد من عدم بقاء المدخلات الحساسة في الذاكرة أكثر من اللازم.
 */
