...
// - تثبيت الخوارزمية ومعالجة الترميز UTF-8 وعدم تغييرها إذا كانت القيم جزءاً من عقد دائم.
// - عند أي ترقية تشفيرية مستقبلية يجب دعم الترحيل/الإصدارات بدلاً من كسر القيم القديمة.
