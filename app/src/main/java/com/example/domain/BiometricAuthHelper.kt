...
// - الإبقاء على المصادقة الحيوية كطبقة تكامل مع AndroidX دون نقل منطق الأعمال إليها.
// - اختبار حالات عدم وجود مستشعر، وعدم التسجيل، والقفل المؤقت، والإلغاء.
// - تجنب ربط نجاح المصادقة بحالة واجهة Compose مباشرةً؛ الأفضل إبقاء القرار في طبقة الحالة/الأعمال.
