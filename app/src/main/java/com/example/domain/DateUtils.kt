...
// - تثبيت المنطقة الزمنية المقصودة لكل عملية مالية أو عرضية وعدم خلط UTC مع الوقت المحلي.
// - إضافة اختبارات حدودية لنهاية الشهر والسنة والمنطقة الزمنية والتوقيت الصيفي حيث ينطبق.
