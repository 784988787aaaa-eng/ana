...
// - الحفاظ على BigDecimal وعدم استبداله بـ Double في المسار المالي.
// - إضافة اختبارات شاملة لأسبقية العمليات والقسمة على صفر والأرقام العربية والفارسية.
// - إذا توسع المحرك لدعم الأقواس أو النسب فيجب تصميم grammar صريحة بدلاً من ترقيعات شرطية متراكمة.
