...
// - الحفاظ على مصدر واحد للحقيقة في الحسابات المالية لمنع اختلاف القيم بين الشاشة والتقرير.
// - اختبار BigDecimal للرصيد المدين والدائن والعملات الأجنبية وحالات التقريب.
// - مراجعة تكلفة إعادة الحساب مع نمو عدد العملاء والمعاملات.
